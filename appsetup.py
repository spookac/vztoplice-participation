#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe application.py -W appsetup.py
...
application = Target(
    ...
    script="application.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'application'
